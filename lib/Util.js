...
Util.getAdminData = function () {
    return new Promise(function (resolve, reject) {
        let connection = new Connection(tediousConfig);
        let sqlStr = 'select * from MainDataDev';
        connection.on('connect', function (err) {
            if (err) {
                reject(err);
            }
...
Util.getReviewerData = function (reviewer, username) {
    return new Promise(function (resolve, reject) {
        let connection = new Connection(tediousConfig);
        let sqlStr = 'select * from MainDataDev where Reviewer=N\'' + reviewer + '\' or RecordOwner=N\'' + username + '\'';
        connection.on('connect', function (err) {
            if (err) {
                reject(err);
            }
...
Util.getUserData = function (username) {
    return new Promise(function (resolve, reject) {
        let connection = new Connection(tediousConfig);
        let sqlStr = 'select * from MainDataDev where RecordOwner=N\'' + username + '\'';
        connection.on('connect', function (err) {
            if (err) {
                reject(err);
            }
...
Util.updateMainData = function (mainData) {
    return new Promise(function (resolve, reject) {
        ...
        connection.on('connect', function (err) {
            ...
            let sqlStr = 'update MainDataDev set ' +
    ...
    return new Promise(function (resolve, reject) {
        Util.getOpportunityCode().then(code => {
            ...
            connection.on('connect', function (err) {
                ...
                let sqlStr = 'INSERT INTO MainDataDev (Reviewer, BUDistrict, OpportunityCode, Province, City, Site, ChineseName, EnglishName, ' +
                    ...
                    'FirstCollaborationDate, EstimatedPCO, Remark, MarketClassification, RecordOwner, ServiceTimeRequested) VALUES (' +
                    'N\'' + mainData.Reviewer + '\', ' +
...
Util.getMainDataByID = function (mainDataID) {
    return new Promise(function (resolve, reject) {
        ...
        connection.on('connect', function (err) {
            ...
            let sqlStr = 'select * from MainDataDev where ID=' + mainDataID;
            let request = new Request(sqlStr, function (err) {
                if (err) {
                    reject(err);
                }
...
Util.deleteMainData = function (mainData) {
    return new Promise(function (resolve, reject) {
        ...
        connection.on('connect', function (err) {
            ...
            let sqlStr = 'delete from MainDataDev where ID=' + mainData.ID;
...
Util.getOpportunityCode = function () {
    return new Promise(function (resolve, reject) {
        ...
        connection.on('connect', function (err) {
            ...
            let sqlStr = 'select * from MainDataDev where OpportunityCode like\'%' + tempDate + '%\'';
            let request = new Request(sqlStr, function (err) {
                if (err) {
                    reject(err);
                }
